...
class SearchAdapter: ListAdapter<Article, SearchAdapter.SearchViewHolder>(DiffCallbackArticle()) {

    class SearchViewHolder(private val binding: ItemLatestNewsBinding): RecyclerView.ViewHolder(binding.root){
